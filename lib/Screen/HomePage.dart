...
class _HomePageState extends State<HomePage>
                ...
                child: ClipRRect(
                    ...
                    child: Hero(
                      ...
                      child: FadeInImage(
                        ...
                        width: double.maxFinite,
                        fit: extendImg ? BoxFit.contain : BoxFit.contain,
    ...
    try {
      ...
      apiBaseHelper.postAPICall(getSettingApi, parameter).then((getdata) async {
        ...
        if (!error) {
          ...
          debugPrint("local pickup****${IS_LOCAL_PICKUP}");
          ...
          if (isVerion == "1") {
            ...
            debugPrint(
                "latest version****$latestVersionAnd******$currentVersion");
  ...
  Future<void> getMostLikePro() async {
    debugPrint("proIds len***${proIds.length}");
    if (proIds.isNotEmpty) {
      ...
      if (_isNetworkAvail) {
        try {
          ...
          debugPrint("product param****$parameter");
          apiBaseHelper.postAPICall(getProductApi, parameter).then(
            ...
            if (!error) {
              ...
              debugPrint("most like****${mostLikeProList.length}");

...
/*    //----- Tax calculation
  ...
  cartFun(int index, int selectedPos, double total) async {
    ...
    if (int.parse(MAX_ITEMS!) > cartCount) {
      ...
      debugPrint("cartslist len***${cartList.length}");
                              ...
                              onBtnSelected: () async {
                                if (isPromoLen == false) {
                                  if (oriPrice >= 200) {
                                    ...
                                    setSnackbar(
                                        "Minimum order price should be Rs.200/-",
                                                ...
                                                onBtnSelected: /*_placeOrder
                                                  ...
                                                  if (isStorePickUp ==
                                                    ...
                                                    checkoutState!(() {
                                                      ...
                                                      oriPrice) {
                                                    setSnackbar(
                                                        'Minimum order value: $MIN_ALLOW_CART_AMT',
                                                        context);
  ...
  razorpayPayment(String orderID, String? msg) async {
    ...
    if (contact != '' && email != '') {
      ...
      try {
        ...
        debugPrint('razorpar para $options');
